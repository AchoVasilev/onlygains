...
export class TodoItemService {
  ...
  checkItem(itemId: string): Observable<TodoItemDetailsResource> {
    return this.http.patch<TodoItemDetailsResource>(
      `${this.apiUrl}/${itemId}`,
      {}
    );
  }
  ...
  createItem(
    item: CreateTodoItemResource
  ): Observable<TodoItemDetailsResource> {
  ...
  editItem(item: EditTodoItemResource): Observable<TodoItemDetailsResource> {
    return this.http.put<TodoItemDetailsResource>(
      `${this.apiUrl}/${item.id}`,
      item
    );
  }
